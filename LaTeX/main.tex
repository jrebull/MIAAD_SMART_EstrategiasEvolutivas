...
La Tabla~\ref{tab:resultados} consolida los tres indicadores por variante. Como todas las corridas alcanzan el óptimo, el Gap final es numéricamente nulo y la tasa de éxito es del 100\,\%; el diferenciador es la \textbf{velocidad de convergencia}.
...
\begin{tabular}{lcccc}
    ...
    \textcolor{white}{\textbf{Gap final}} &
    \textcolor{white}{\textbf{Éxito (\%)}} &
    \textcolor{white}{\textbf{Gen}$\bm{\to 0.95}$} &
    \textcolor{white}{\textbf{Mejor fitness prom.}} \\
    \midrule
    $(\mu+\lambda)$ Isotrópica    & $<10^{-16}$              & $100.0$ & $22.23 \pm  3.46$ & $1.000000$ \\
    \rowcolor{gray!8}
    $(\mu,\lambda)$ Isotrópica    & $1.7\times10^{-16}$      & $100.0$ & $24.00 \pm  3.01$ & $1.000000$ \\
    $(\mu+\lambda)$ Anisotrópica  & $<10^{-16}$              & $100.0$ & $31.70 \pm  7.27$ & $1.000000$ \\
    \rowcolor{gray!8}
    $(\mu,\lambda)$ Anisotrópica  & $3.0\times10^{-16}$      & $100.0$ & $39.23 \pm 13.78$ & $1.000000$ \\
    \bottomrule
\end{tabular}
\end{table}
