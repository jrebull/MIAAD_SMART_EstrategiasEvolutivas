...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small\MakeUppercase{Optimización Inteligente}}
\fancyhead[R]{\small\MakeUppercase{MIAAD} \textcolor{uacjgray}{\textbullet} \MakeUppercase{UACJ}}
\fancyfoot[C]{\thepage}
...
\begin{minipage}[c]{2.5cm}
    \includegraphics[width=2.5cm, keepaspectratio]{LogoSInFondoMIAAD.png}
\end{minipage}%
\hfill
\begin{minipage}[c]{\dimexpr\textwidth-5.2cm\relax}
    \centering
    {\Large\bfseries\MakeUppercase{Universidad Autónoma de Ciudad Juárez}}\\[2pt]
...
% ==========================================
\begin{notebox}
\textbf{Recursos del proyecto:}\\[4pt]
\small
\textbullet~Repositorio (GitHub): \url{https://github.com/jrebull/MIAAD_SMART_EstrategiasEvolutivas}\\[2pt]
\textbullet~Sitio interactivo: \url{https://miaad-smart-estrategiasevolutivas.netlify.app/}\\[4pt]
\normalsize El repositorio contiene el código fuente en Python, los resultados de las 120~ejecuciones, las figuras a 300\,DPI, el sitio web Nuxt~3 con resultados interactivos y el presente reporte. El sitio publicado permite consultar gráficas dinámicas y la evolución de~$\boldsymbol{\sigma}$ en el navegador.
\end{notebox}
...
\begin{tabular}{lcccc}
    ...
    \textcolor{white}{\textbf{Gen $\to$ 0.95}} &
